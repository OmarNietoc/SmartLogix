...
public class OrderShippedConsumer {
    ...
    public void handleOrderShipped(OrderShippedEvent event) {
        try {
            ...
            log.error("Error procesando shipped orderId={}: {}", event.orderId(), e.getMessage());
            throw new AmqpRejectAndDontRequeueException("Error procesando shipped para orderId=" + event.orderId(), e);
        }
    }
}
